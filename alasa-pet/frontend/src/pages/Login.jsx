                ...
                <div>
                    ...
                    <form className='p-4 mx-auto w-96 sm:px-9 mt-8 shadow-md'>
                        <div className='mb-5'>
                            ...
                            <input type="email" id="email" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='admin@mail.com' /> 
                        </div>
                        <div className='mb-5'>
                        ...
                        <div className='flex justify-between px-4 mt-5 text-slate-500'>
                            ...
                            <Link to="/olvide-password" className=''> Olvidé mi password </Link>
                        </div>
                    </form>
                </div>
            </div>
